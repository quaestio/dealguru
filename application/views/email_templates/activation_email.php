...
<title>User Activation_template</title>
                                    ...
                                    <table  border="0" cellpadding="0" cellspacing="0" align="left" class="deviceWidth">
                                        <tr>
                                            <td class="center" style="padding: 10px 0px 10px 0px">
                                                <a href="#"><img src="<?=base_url();?>logo.png"></a>
                                            </td>
                                        </tr>
                                    </table><!--End logo-->
                                    <!--Start nav-->
                                    <table  border="0" cellpadding="0" cellspacing="0" align="right" class="deviceWidth">
                                        <tr>
                                            <td  class="center" style="font-size: 13px; color: #272727; font-weight: light; text-align: center; font-family: Arial, Helvetica, sans-serif; line-height: 25px; vertical-align: middle; padding: 10px 0px 10px 0px;">
                                                <a href="<?=base_url();?>" style="text-decoration: none; color: #3b3b3b;">Deals</a>
                                    ...
                                    <table  border="0" cellpadding="0" cellspacing="0" align="center"> 
                                        <tr>
                                            <td  class="center" style="font-size: 16px; color: #687074; font-weight: bold; text-align: center; font-family: Arial, Helvetica, sans-serif; line-height: 25px; vertical-align: middle; padding: 20px 10px 10px;">
                                                Dear <?=$user_details['FULL_NAME']?> ,
                                                <br />Thank youo for connected wuth us  
                                                 Your Activation code is: <span class="text-red"><?=$user_details['ACT_CODE']?></span>                      
                                           </td>
                                        </tr>
                                    </table>
                                </td>
                        ...
                        <tr>
                            <td width="100%" bgcolor="#f7f7f7"> 
                                ...
                                <table width="33%"  border="0" cellpadding="0" cellspacing="0" align="left" class="deviceWidth">
                                    <tr>
                                        <td valign="top" style="padding: 20px 30px " class="center">
                                            <a href="#"><img width="144" hight="144" src="img/brands/natural.png"></a>
                                        </td>
                                    </tr>
                                </table><!--End Image 1-->
                                <!--Start Image 2-->
                                <table width="33%"  border="0" cellpadding="0" cellspacing="0" align="left" class="deviceWidth">
                                    <tr>
                                        <td valign="top" style="padding: 20px 30px " class="center">
                                            <a href="#"><img width="144" hight="144" src="img/brands/everyday.png"></a>
                                        </td>
                                    </tr>
                                </table><!--End Image 2-->    
                                <!--Start Image 3-->
                                <table width="33%"  border="0" cellpadding="0" cellspacing="0" align="left" class="deviceWidth">
                                    <tr>
                                        <td valign="top" style="padding: 20px 30px " class="center">
                                            <a href="#"><img width="144" hight="144" src="img/brands/gamescast.png"></a>
                                        </td>
                                    </tr>
                                </table><!--End Image 3-->
                            </td>     
                        ...
                        <tr>
                            <td width="100%" bgcolor="#f7f7f7">
                                ...
                                <table width="33%"  border="0" cellpadding="0" cellspacing="0" align="left" class="deviceWidth">
                                    <tr>
                                        <td valign="top" style="padding: 20px 30px " class="center">
                                            <a href="#"><img width="144" hight="144" src="img/brands/cisco.png"></a>
                                        </td>
                                    </tr>
                                </table><!--End Image 1-->
                                <!--Start Image 2-->
                                <table width="33%"  border="0" cellpadding="0" cellspacing="0" align="left" class="deviceWidth">
                                    <tr>
                                        <td valign="top" style="padding: 20px 30px " class="center">
                                            <a href="#"><img width="144" hight="144" src="img/brands/spinworkx.png"></a>
                                        </td>
                                    </tr>
                                </table><!--End Image 2-->    
                                <!--Start Image 3-->
                                <table width="33%"  border="0" cellpadding="0" cellspacing="0" align="left" class="deviceWidth">
                                    <tr>
                                        <td valign="top" style="padding: 20px 30px " class="center">
                                            <a href="#"><img width="144" hight="144" src="img/brands/walmart.png"></a>
                                        </td>
                                    </tr>
                                </table><!--End Image 3 -->
                            </td>     
                        ...
                        <table  border="0" cellpadding="0" cellspacing="0" align="center"> 
                            <tr>
                                <td valign="top" style="padding: 20px 10px " class="center">
                                    <a href="#"><img width="32" hight="32" src="img/icons/icon_facebook.png"></a>
                                </td>
                                <td valign="top" style="padding: 20px 10px " class="center">
                                    <a href="#"><img width="32" hight="32" src="img/icons/icon_twitter.png"></a>
                                </td>
                                <td valign="top" style="padding: 20px 10px " class="center">
                                    <a href="#"><img width="32" hight="32" src="img/icons/icon_youtube.png"></a>
                                </td>
                            </tr>
                        </table>
                        <table  border="0" cellpadding="0" cellspacing="0" align="center"> 
                ...
                <tr>
                  ...
                  <tr>
                    <td  bgcolor="#ffffff" class="center" style="font-size: 12px; color: #687074; font-weight: bold; text-align: center; font-family: Arial, Helvetica, sans-serif; line-height: 25px; vertical-align: middle; padding: 20px 10px; " >
                         If you would prefer not to receive email communications from us click <a style="text-decoration: none; color: #3498db;" href="#">here</a>  
                    </td>
                </tr>
            </table>
            <!--End Footer-->
